...
@section('content')
    ...
    <form method="POST" action="{{ route('students.update', $student) }}">
        ...
        <div class="card"><div class="card-body"><div class="row">
            ...
            <div class="form-group col-md-6"><label for="active">Status</label><select id="active" name="active" class="form-control"><option value="1" @selected(old('active', $student->active))>Ativo</option><option value="0" @selected(! old('active', $student->active))>Inativo</option></select></div>
