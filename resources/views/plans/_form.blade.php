<form method="POST" action="{{ $formAction }}">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-4"><label for="price" class="form-label">Valor mensal *</label><input id="price" name="price" type="number" min="0" step="0.01" class="form-control" value="{{ old('price', $plan->price) }}" required></div>
